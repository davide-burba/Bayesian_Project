...
#  
# NB:  ZELLNER PRIOR, c=50 (per fixed coefficients)!
#      
#     same covariates as model 6 plus visit2, some here are random!
#     intercept both tandom and fixed
...
for (i in 1:npat){
  b1=data[,first.b1.pos+3*(i-1)]
  b2=data[,first.b1.pos+1+3*(i-1)]
  b3=data[,first.b1.pos+2+3*(i-1)]
  tmp_b=cbind(b1,b2,b3)
