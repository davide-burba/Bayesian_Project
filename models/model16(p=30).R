#Modello con priors parametriche e regressori scelti con Spike&Slab
...
save.image("../R_object/model_16(p=30).RData")

load("../R_object/model_16(p=30).RData")
...
Indices
save(Indices,file="../R_object/model_16(p=30)_indices.RData")
