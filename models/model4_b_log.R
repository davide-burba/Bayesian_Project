#
# This model is the same as model 4 but using log(RNFL) come risposta
#
...
# NO RANDOM
data=list( y=RNFL_log, X=X,  npat= length(unique(Patient)), 
...
#save.image("../R_object/model_4_b.RData")

rm(list=ls())
load("../R_object/model_4_b.RData")
