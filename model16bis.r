#Modello con priors parametriche e regressori scelti con Spike&Slab (rimosse quelle
#di troppo in model16)
...
save.image("../R_object/model_16bis.RData")

load("../R_object/model_16bis.RData")
...
Indices
save(Indices,file="../R_object/model_16bis_indices.RData")
