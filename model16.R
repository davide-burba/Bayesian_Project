#Modello con priors parametriche e regressori scelti con Spike&Slab...nella Wishart p=100->
#->indici merdosi ma migliori rispetto al modello con le covaiate del model 14.
...
save.image("../R_object/model_16.RData")

load("../R_object/model_16.RData")
...
plot(sort(bres^2),ylim=c(0,500),pch=16) 
...
save(Indices,file="../R_object/model_16_indices.RData")
